...
- Commercial Package Insights (approved September 15, 2026): omit all source-info controls throughout the “Your policy simplified” card, including its coverage-parts overview. Show the full policy number as always-visible text without an eye/reveal or hide control. Show only the premium amount in the premium field; omit the “subject to adjustment” qualifier there. Retain source controls in the remaining sections and document references under About these insights. In source bottom sheets and desktop source panels, show a single “View in document” action opening the primary cited PDF page. Keep all supporting page references in the source text; omit additional “View PDF page” actions. This exception is scoped to Commercial Package details and does not change identifier masking or source actions on other policy types.

- Personal Boat simplified card (approved September 16, 2026): omit the “Sample wording” badge and all source-info controls throughout “Your policy simplified.” Retain the document-availability note and source controls in the remaining sections, including Document sources.
- Personal Boat footer (approved September 17, 2026): omit the “Review with your insurance professional” action from About these insights. Retain the approved disclaimer, document-availability note and source disclosures.
- Personal Auto simplified card (approved September 15, 2026): omit all source-info controls throughout “Your policy simplified.” Show only the date range for Policy period and the amount with term length for Coverage premiums. Omit the time-of-day note, premium-calculation note, Payment plan field and local educational disclaimer; end the card after Coverage premiums. Retain source controls in the remaining sections, including Document sources, and the full disclaimer under About these insights.
- Personal Auto coverage placement (approved September 15, 2026): place What’s included, What’s not included, Coverage limitations, and Coverage watch points as independently expandable standard disclosures inside one Policy details card, rather than vehicle-level tabs. Preserve vehicle-specific explanations grouped by actual vehicle name. Include Policy specifications in that card and consolidate policy-wide and vehicle-specific watch points in its single Coverage watch points disclosure. Keep each vehicle’s coverage/premium table on the vehicle and retain the SME-required dedicated Deductibles section. End Deductibles after Important to know; omit its insurance-professional review button and claim-decision guidance sentence. Keep the review action under About these insights.
- Commercial Auto Insights (approved September 15, 2026): omit source-info controls throughout the “Your policy simplified” card. Show the full policy number as always-visible text without an eye/reveal control. Retain source controls in the remaining sections. This exception is scoped to Commercial Auto details and does not change identifier masking on policy lists or other policy types.
- Commercial Auto coverage placement (approved September 15, 2026): place What’s included, What’s not included, Coverage limitations, and Coverage watch points as standard disclosures inside Policy details. Keep Covered autos focused on vehicle identity, VIN, garaging and vehicle premium. Group coverage rows by vehicle when multiple autos are shown inline; retain the searchable fleet list and per-auto detail surface for large schedules. Show the policy watch-point disclosure once.
- Commercial Auto source panels (approved September 15, 2026): show a single “View in document” action opening the primary cited PDF page. Keep all supporting page references in the source text; omit additional page-specific action buttons.
- Commercial Auto source-sheet layout (approved September 15, 2026): follow the umbrella prototype with a bottom-attached sheet centered on the app shell at every browser width, capped at the lesser of 76dvh and 680px. Keep its handle, title, and close control outside the single scrolling body. Group structured schedule evidence in the same neutral inset surface as policy excerpts, retaining labeled rows and qualifications. Keep the single document action after the evidence in the reading flow.

- Commercial general liability Insights (approved September 15, 2026): show the full policy number at all times in the simplified card, without a reveal/hide control. Omit source-info controls throughout that card. Omit the Coverage basis row and the entire Additional policy information disclosure; end the card after the premium field. Show only the date range for Policy term and the policy premium amount for Policy premium; omit their supporting paragraphs. Place the endorsement summary inside What’s included, after its coverage rows, so it collapses with that section. Omit the standalone Ask Ovie scenario CTA beneath the endorsement note; retain the persistent composer. Detail rows follow the commercial property heading/source row and full-width supporting-copy structure; preserve 16px content gutters and transparent source-control hover backgrounds.

- Commercial umbrella Insights (approved September 15, 2026): follow the umbrella reference's plain “Your policy simplified” fields, without source-info controls in that card. Show the full policy number as always-visible text with no eye/reveal control. Put occurrence and aggregate limits in a separate white “Umbrella protection” card with source controls. Keep supporting classification reasoning in Policy specifications and premium availability details in About these insights. Use the shared label/value typography, 16px card gutters, subtle row dividers, and an up-to-480px responsive preview shell. Source and back controls retain transparent backgrounds on hover, matching the umbrella reference; Back uses `icon-strong`. This visibility exception is scoped to commercial umbrella details and does not change identifier masking on other pages.
